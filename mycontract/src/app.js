App = {
    ...
    initContracts: async () => {
      const contract = await $.getJSON('NFTMarketplace.json')
      App.contracts.NFTMarketplace = TruffleContract(contract)
      App.contracts.NFTMarketplace.setProvider(App.web3Provider)
    ...
    //   const contract = await App.contracts.MyContract.deployed()
      const contract = await App.contracts.NFTMarketplace.deployed()
